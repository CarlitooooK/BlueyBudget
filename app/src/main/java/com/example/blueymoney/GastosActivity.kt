...
class GastosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        agregarMovimiento("Renta", "$10,000.00", R.drawable.ic_renta)
    ...
    private fun agregarMovimiento(nombre: String, monto: String, icono: Int) {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Aceptar") { _, _ ->
                ...
                if (nombre.isNotEmpty() && monto.isNotEmpty()) {
                    agregarMovimiento(nombre, "$$monto", iconoSeleccionado)
                } else {
